...
describe Locomotive::Entities::Page, pending: true do
  ...
  describe 'building a page from attributes' do
    ...
    it 'sets a localized attribute' do
      ...
      Locomotive::Models.with_locale(:fr) { page.title.should be_nil }
    ...
    it 'sets a complete translation of a localized attribute' do
      ...
      page.title.should eq 'Hello world'
      Locomotive::Models.with_locale(:fr) { page.title.should == 'Salut le monde' }
    end
  ...
  describe 'translations' do
    ...
    it 'is translated if we use the direct attribute setter' do
      page = build_page(title: 'Hello world')
      Locomotive::Models.with_locale(:fr) { page.title = 'Salut le monde' }
  ...
  describe 'layout' do
    ...
    # it 'is not a layout if the template is empty', pending: true do
    ...
    describe 'localizing the fullpath' do
      ...
      it 'localizes the index page for all the locales' do
        ...
        [:fr, :de].each do |locale|
          Locomotive::Models.with_locale(locale) { @page.fullpath.should == 'index' }
        end
      end
      ...
      it 'takes the default locale to fill the fullpath' do
        @child.localize_fullpath([:en, :fr])
        Locomotive::Models.with_locale(:fr) { @child.fullpath.should == 'child' }
      end
      ...
      it 'takes the parent fullpath to localize the fullpath of a child' do
        ...
        Locomotive::Models.with_locale(:fr) { @sub_child.fullpath.should == 'child/sous-enfant' }
      end
  ...
  describe 'deprecated methods' do
    ...
    it 'responds to the model setter' do
      Locomotive::Common::Logger.should_receive(:warn)
        .with('The model attribute is deprecated. Use content_type instead.')
